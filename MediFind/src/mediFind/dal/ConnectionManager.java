...
public class ConnectionManager {
	...
	private final String user = "medifind_root";
	// Password for the user.
	private final String password = "medifindroot";
	// URI to your database server. If running on the same machine, then this is "localhost".
	private final String hostName = "west2-mysql-medifind.czdemvcxik9i.us-west-2.rds.amazonaws.com";
	// Port to your database server. By default, this is 3307.
	private final int port= 3306;
	// Name of the MySQL schema that contains your tables. 
	private final String schema = "medifindapplication";
